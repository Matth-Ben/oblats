...
= 5.4.1 (2022-11-13) =
* `[Added]` Possibility to manually delete original files after converting to WebP/AVIF, after disabling "Automatic removal of files in output formats larger than original" option in plugin settings
